    ...
    <div className="flex flex-wrap items-center gap-3">
      ...
      <div className="flex flex-wrap gap-2">
        <button
          ...
          className="p-2 rounded-lg bg-[#1da1f2] text-white hover:bg-[#1a91da] transition-colors duration-200"
        ...
        <button
          ...
          className="p-2 rounded-lg bg-[#1877f2] text-white hover:bg-[#166fe5] transition-colors duration-200"
        ...
        <button
          ...
          className="p-2 rounded-lg bg-[#25d366] text-white hover:bg-[#20ba5a] transition-colors duration-200"
        ...
        <button
          ...
          className="p-2 rounded-lg bg-[#0088cc] text-white hover:bg-[#0077b3] transition-colors duration-200"
        ...
        {typeof window !== 'undefined' && typeof navigator !== 'undefined' && 'share' in navigator && (
          <button
            ...
            className="p-2 rounded-lg bg-[#6b8e6b] text-white hover:bg-[#5a7a5a] transition-colors duration-200"
            aria-label="Share"
          >
