...
export default function SocialShare({ title, url, description }: SocialShareProps) {
  ...
  const handleLinkedIn = () => {
    // Open LinkedIn profile link instead of share
    window.open('https://www.linkedin.com/in/tejas-chingaravel-kumaran-b99704267?utm_source=share_via&utm_content=profile&utm_medium=member_ios', '_blank')
  }
