  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Post Content */}
        <article className="prose prose-lg max-w-none bg-white dark:bg-[#252525] border border-[#e2e8f0] dark:border-[#4a5568] rounded-xl p-8 animate-slide-up shadow-sm" style={{animationDelay: '0.2s'}}>
