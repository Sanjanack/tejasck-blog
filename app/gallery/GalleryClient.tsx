...
import type { GalleryImagePublic } from '@/app/lib/gallery'
import { IconDocument, IconGlobe } from '../components/Icons'

export default function GalleryClient({ images }: { images: GalleryImagePublic[] }) {
  ...
  return (
    <div className="relative min-h-screen bg-[#faf9f7] dark:bg-[#1a1a1a] pt-16">
      ...
      {activeImage && (
        ...
        >
          <div
            className="w-full max-w-4xl bg-white dark:bg-[#252525] border border-[#e2e8f0] dark:border-[#4a5568] rounded-2xl overflow-hidden shadow-2xl"
